...
namespace McTools.Xrm.Connection.WinForms
{
    ...
    public partial class CRMLoginForm1 : Window
    {
        ...
        /// </summary>
        public CrmServiceClient CrmSvc { get; private set; }
        ...
        public CRMLoginForm1(Guid connectionDetailId, bool isUpdate = false)
        {
        ...
        {
            MessageBox.Show(this, e.ErrorMessage, "Connection failed", MessageBoxButton.OK, MessageBoxImage.Error);
        }
...
*/
    ...
    #endregion system.diagnostics settings for this control
}